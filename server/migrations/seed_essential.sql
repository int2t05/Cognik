...
(1, 'GLM + DashScope',        'https://st8tp3ajl0df3n8b8l8qu.apigateway-cn-beijing.volceapi.com/v1', '7cbc03aa-ebfd-421c-9217-f31a13a0eebc', 'https://llm-okvb99vfel2z5w65.cn-beijing.maas.aliyuncs.com/compatible-mode/v1', 'sk-ws-placeholder', 'glm-5.2', 'text-embedding-v2', NULL, 1000000, 1536, false, NOW(), NOW()),
